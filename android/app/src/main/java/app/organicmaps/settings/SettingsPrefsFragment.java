...
public class SettingsPrefsFragment extends BaseXmlSettingsFragment implements LanguagesFragment.Listener
{
  ...
  public boolean onPreferenceTreeClick(Preference preference)
  {
    ...
    if (key != null)
    {
      ...
      else if (key.equals(getString(R.string.pref_cycling_screen)))
      {
      ...
      else if (key.equals(getString(R.string.pref_segments_screen)))
      {
        getSettingsActivity().stackFragment(SegmentsFragment.class, getString(R.string.cycling_segments_title), null);
      }
